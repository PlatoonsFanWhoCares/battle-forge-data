...
![Scattering](https://github.com/wargame-engine/root/raw/master/rules/diagrams/scatter2.png)
# Datasheets
...
### Shift
All models in the unit may change one gear.
#### Push It
When performing a shift action, a unit may attempt to push it. The unit takes an Initiative skill check. If passed, the unit may change 2 gears instead. If failed, the unit takes a Shock at the end of the Move and does not gain any benefit.
### Hold
...
# Movement (TODO)
Movement takes place after a unit has made both of its actions. Movement must be in a straight line and a unit must move its full movement distance.
![Movement](https://github.com/wargame-engine/root/raw/master/rules/diagrams/movement.png)
## Gears
When moving, vehicles have several gears which can be changed to match desired speed.
### Reverse
A vehicle in reverse may move half speed directly backwards.
### Stop
A vehicle stopped suhffers no penalties and does not move.
### Half-Speed
A vehicle at half-speed may move half its printed movement speed
### Full Speed
A vehicle at full speed may move its entire movement distance.
### Double Speed
A vehicle at double speed may move twice its printed movement speed. It may not turn when moving.
## Turning
A vehicle may turn up to 45 degrees at any point during its move.
### Hard Turn
When turning, a unit may attempt to push it. The unit takes an Initiative skill check. If passed, the unit may turn up to an additional 45 degrees. If failed, the unit takes a Shock at the end of the Move and does not gain any benefit.
## Collisions (TODO)
If a unit crosses paths with another vehicle or part of the terrain, a collision may occur.
# Shooting
...
![Shooting](https://github.com/wargame-engine/root/raw/master/rules/diagrams/shooting.png)
## Line of Sight (LOS)
...
![Arc Diagram](https://github.com/wargame-engine/root/raw/master/rules/diagrams/arcs.png)
## Shooting Sequence
...
### Purchasing a Legend
Legends may be purchased using list building points and have a limit to how many may be taken. Typically they will replace an item or unit, or give a unit additional abilities. Players make take one legend per 100 game points being played. For games under 100 points, players may each simply take one legend. Each legend also may only be taken once in a list.

__For Example:__ We are playing a 200 point game, and 200/100 = 2 allowed legends. If we are playing a 100 point game, I am allowed to take 1 legend.
### Force Organizations
...
[Token Set](https://github.com/wargame-engine/root/raw/master/rules/Battle_Forged_Tokens.pdf)
